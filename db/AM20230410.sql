...
INSERT INTO `bitacora` VALUES (1,2,'2023-04-06','08:43:42','Entrada',NULL,NULL),(2,2,'2023-04-06','09:53:41','Entrada',NULL,NULL),(3,2,'2023-04-06','09:59:09','Entrada',NULL,NULL),(4,2,'2023-04-06','10:43:29','Entrada','10:43:42',13);
...
INSERT INTO `funciones` VALUES (5,2,3,'unnnn','numero',3,'2023-02-03 00:00:00','2023-02-05 05:00:00');
...
CREATE TABLE `reportes` (
  ...
  CONSTRAINT `fk_acciones_1` FOREIGN KEY (`idfunciones`) REFERENCES `funciones` (`id_acciones`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_personal_1` FOREIGN KEY (`idpersonal`) REFERENCES `personal` (`id_personal`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
-- Dump completed on 2023-04-10  9:38:42
