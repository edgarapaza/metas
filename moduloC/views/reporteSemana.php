...
<html lang="es">
    ...
    <header id="header" class="header fixed-top d-flex align-items-center">
        ...
        <ul class="d-flex align-items-center">
            ...
            <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow profile">
                ...
                <li>
                <a class="dropdown-item d-flex align-items-center" href="../controllers/sessionClose.controller.php">
    ...
    <aside id="sidebar" class="sidebar">
        ...
        <li class="nav-item">
            ...
            <li>
                <a href="reporteSemana.php">
                <i class="bi bi-circle"></i><span>Ver mis reportes</span>
                </a>
            </li>
            </ul>
        ...
        <li class="nav-item">
            ...
            <i class="bi bi-journal-text"></i><span>Fomularios</span><i class="bi bi-chevron-down ms-auto"></i>
            </a>
        ...
        <li class="nav-item">
            ...
            <i class="bi bi-layout-text-window-reverse"></i><span>Tabla</span><i class="bi bi-chevron-down ms-auto"></i>
            </a>
