...
<body>
      ...
      <ul class="d-flex align-items-center">
        ...
        <li class="nav-item dropdown pe-3">
          ...
          <a class="nav-link nav-profile d-flex align-items-center pe-0" href="#" data-bs-toggle="dropdown">
            ...
            <span class="d-none d-md-block dropdown-toggle ps-2"><?php echo $data['nombre']." ".$data['apellidos'];?></span>
  ...
  <!-- ======= Sidebar ======= -->
  <aside id="sidebar" class="sidebar rojo">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" data-bs-target="#components-nav" data-bs-toggle="collapse" href="#">
          <i class="bi bi-menu-button-wide"></i><span>Institucional</span><i class="bi bi-chevron-down ms-auto"></i>
        </a>
        <ul id="components-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
          <li>
            <a href="institucion.php">
              <i class="bi bi-circle"></i><span>Agregar Institucion</span>
            </a>
          </li>
          <li>
            <a href="gerencia.php">
              <i class="bi bi-circle"></i><span>Agregar Gerencia</span>
            </a>
          </li>

          <li>
            <a href="subgerencia.php">
              <i class="bi bi-circle"></i><span>Agregar Sub Gerencia</span>
            </a>
          </li>

          <li>
            <a href="oficinas.php">
              <i class="bi bi-circle"></i><span>Agregar Oficinas</span>
            </a>
          </li>

          <li>
            <a href="areas.php">
              <i class="bi bi-circle"></i><span>Agregar Areas</span>
            </a>
          </li>
      ...
      <li class="nav-item">
        ...
        <ul id="forms-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
          <li>
            <a href="reportGerencia.php">
              <i class="bi bi-circle"></i><span>Gerencias</span>
            </a>
          </li>

          <li>
            <a href="reportSubGerencia.php">
              <i class="bi bi-circle"></i><span>Sub Gerencias</span>
            </a>
          </li>

          <li>
            <a href="reportOficina.php">
              <i class="bi bi-circle"></i><span>Oficinas</span>
            </a>
          </li>

          <li>
            <a href="reportPersona.php">
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" data-bs-target="#charts-nav" data-bs-toggle="collapse" href="#">
          <i class="bi bi-bar-chart"></i><span>Graficos</span><i class="bi bi-chevron-down ms-auto"></i>
        </a>
        <ul id="charts-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
          <li>
            <a href="graficoMensual.php">
